...
$pesquisa = isset($_GET['query']) ? $_GET['query'] : '';
...
if ($pesquisa) {
    $sql .= " WHERE livros.titulo LIKE :pesquisa";
}
...
<head>
    <meta charset="UTF-8">
    <title>Livros Postados - Merlim</title>
...
<body>
    <header>
        ...
        <form action="livros.php" method="GET" class="BarraPesquisa">
    <input type="text" name="query" placeholder="Pesquisar livros..." value="<?php echo htmlspecialchars($pesquisa); ?>" required>
    ...
    <main>
        ...
        <?php else: ?>
            <center>
            <p>Nenhum Livro Encontrado</center>
        <?php endif; ?>
    </main>
</body>
</html> 
